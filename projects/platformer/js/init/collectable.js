(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 600, 150, 6, 0.7);
        collectable.create(type.kennedi, 300, 270, 6, 0.7);
        collectable.create(type.grace, 600, 370, 6, 0.7); 
        collectable.create(type.max, 300, 470, 6, 0.7);
